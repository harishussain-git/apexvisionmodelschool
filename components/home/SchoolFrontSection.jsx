export default function SchoolFrontSection({ overlay = false, content = {} }) {
  ...
  const description =
    content.description ??
    "At Apex Vision Model School, learning goes beyond classrooms. Through modern facilities, innovative curriculum, and diverse activities, we create a 360 degree student experience."
    ...
    <RootTag
      className={
        overlay
          ...
          : "relative flex h-screen w-full items-center justify-center bg-[url('/homepage/clay/school-front-clay.webp')] bg-cover bg-center"
      }
    >
      <div className="absolute bottom-10 h-fit max-w-[90vw] rounded-2xl border border-white/80 bg-white/30 p-2 backdrop-blur-3xl md:right-10 md:top-14 md:max-w-[70ch]">
