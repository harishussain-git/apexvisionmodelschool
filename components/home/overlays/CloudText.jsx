...
export default function CloudText() {
  return (
    <div className="w-full max-w-[1500px] px-5 sm:px-8 lg:px-12">
      <h1 className="font-accent text-left font-black uppercase leading-[0.98] tracking-[0.03em] text-[#2f469e] text-[clamp(3.5rem,4.9vw,5rem)]">
        <span className="block">Apex Model School Sharjah Empowers Young</span>
        <span className="md:mt-[0.18em] block">
